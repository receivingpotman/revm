...
## [16.0.0](https://github.com/receivingpotman/revm/compare/revm-primitives-v15.1.0...revm-primitives-v16.0.0) - 2025-01-10
...
- document when InvalidTransaction errors are thrown ([#722](https://github.com/receivingpotman/revm/pull/722))
...
- Small doc comment fix ([#698](https://github.com/receivingpotman/revm/pull/698))
...
- Fix typo in primitives/src/state.rs ([#474](https://github.com/receivingpotman/revm/pull/474))
...
- Comment Fix ([#430](https://github.com/receivingpotman/revm/pull/430))
- *(deps)* bump arbitrary from 1.2.3 to 1.3.0 (#428)
- enabled primtive default feature in precompile (#409)
- Update readmdoc of `perf_analyse_created_bytecodes` ([#404](https://github.com/receivingpotman/revm/pull/404))
...
- Add B160/B256 From primitive_types traits ([#380](https://github.com/receivingpotman/revm/pull/380))
...
- nits and num of cargo keyword to 5 ([#351](https://github.com/receivingpotman/revm/pull/351))
...
- expose hashbrown::HashMap in primitives ([#345](https://github.com/receivingpotman/revm/pull/345))
